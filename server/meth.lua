...
RegisterServerEvent('mrich-jobpack:pickedUpHydrochloricAcid', function()
	local src = source
...
RegisterServerEvent('mrich-jobpack:pickedUpSodiumHydroxide', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('mrich-jobpack:pickedUpSulfuricAcid', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('mrich-jobpack:processChemicals', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('mrich-jobpack:processTempUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('mrich-jobpack:processTempDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('mrich-jobpack:processMeth', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('mrich-jobpack:processFailUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('mrich-jobpack:processFailDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
